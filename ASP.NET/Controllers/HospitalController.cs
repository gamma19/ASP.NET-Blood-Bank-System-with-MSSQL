    ...
    public class HospitalController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Hospital != null ? 
                          ...
                          Problem("Entity set 'ApplicationDbContext.Hospital'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("hId,hName,hAddress")] Hospital hospital)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("hId,hName,hAddress")] Hospital hospital)
        {
            if (id != hospital.hId)
            {
                return NotFound();
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!HospitalExists(hospital.hId))
                    {
                        return NotFound();
                    }
                    else
        ...
        {
          return (_context.Hospital?.Any(e => e.hId == id)).GetValueOrDefault();
        }
    }
}
